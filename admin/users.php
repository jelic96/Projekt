<?php 
	...
	if (isset($_POST['edit']) && $_POST['_action_'] == 'TRUE') {
		...
		$_SESSION['message'] = '<p>Uspješno ste izmjenili profil!</p>';
	...
	#Edit user profile
		...
		<form action="" id="registration_form" name="registration_form" method="POST">
			...
			<input type="text" id="fname" name="firstname" value="' . $row['firstname'] . '"  required>

			<label for="lname">Prezime *</label>
			<input type="text" id="lname" name="lastname" value="' . $row['lastname'] . '"  required>
			...
			<input type="text" id="username" name="username" value="' . $row['username'] . '" pattern=".{5,10}"  required><br>
